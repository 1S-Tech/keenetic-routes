...
gen-telegram:
	curl -s -f https://core.telegram.org/resources/cidr.txt | grep -v ':' > vendor/telegram/telegram_cidr.txt
	bin/antifilter vendor/telegram/telegram_cidr.txt routes/telegram-ipv4.bat
