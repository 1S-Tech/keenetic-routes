...
- [gemini.google.com](routes/gemini-ipv4.bat) (диапазоны Google Cloud из [ipranges](https://github.com/lord-alfred/ipranges/tree/main/google))
- [chatgpt.com](routes/chatgpt-ipv4.bat)
- [medium.com](routes/medium-ipv4.bat)
- [notion.so](routes/notion-ipv4.bat) (IPv4 AS33191; часть трафика может быть на CDN — см. [cloudflare](routes/cloudflare-ipv4.bat))
- [rutracker.org](http://rutracker.org/) (IPv4 Cloudflare; при проблемах см. [cloudflare](routes/cloudflare-ipv4.bat))
- [cloudflare](routes/cloudflare-ipv4.bat)
- [telegram](routes/telegram-ipv4.bat)
- [claude.ai](routes/claude-ipv4.bat)
